  ...
  return (
    <section className="idea-tree-native" aria-label="Pin insertion idea tree">
      ...
      <p className="idea-tree-caption">
        ...
        marks an idea that raised the team&rsquo;s best success rate, and green curves trace
        cross-agent inspiration. The lower panel tracks the team-average best success rate climbing
